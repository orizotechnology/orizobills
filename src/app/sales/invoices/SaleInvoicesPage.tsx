...
const rowIconBtn: React.CSSProperties = { width: 28, height: 28, borderRadius: 6, border: "none", background: "transparent", cursor: "pointer", color: "hsl(var(--muted))", display: "flex", alignItems: "center", justifyContent: "center" };
...
const pgBtn = (d: boolean): React.CSSProperties => ({ padding: "6px 14px", borderRadius: 7, border: "1px solid hsl(var(--border))", background: d ? "hsl(var(--background))" : "hsl(var(--card))", color: d ? "hsl(var(--muted))" : "hsl(var(--foreground))", fontSize: 13, cursor: d ? "not-allowed" : "pointer", fontFamily: "inherit" });
