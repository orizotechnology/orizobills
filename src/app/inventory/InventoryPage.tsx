...
import { Package, TrendingUp, AlertTriangle, TrendingDown, RefreshCw, X, Loader2, CheckCircle2, Edit2 } from "lucide-react";
...
export default function InventoryPage() {
  ...
  // Summary from first page (counts the full dataset)
  ...
  return (
    <div style={{ padding: "24px 28px", height: "100%", display: "flex", flexDirection: "column", background: "#F8FAFC" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 16, flexShrink: 0 }}>
        {[
          { icon: <Package size={20} color="#F97316" />,       label: "Total Products", value: String(summary.total),      color: "#F97316", f: "ALL"          },
          { icon: <TrendingUp size={20} color="#22C55E" />,    label: "In Stock",       value: String(summary.inStock),    color: "#22C55E", f: "IN_STOCK"     },
          { icon: <AlertTriangle size={20} color="#EAB308" />, label: "Low Stock",      value: String(summary.lowStock),   color: "#EAB308", f: "LOW_STOCK"    },
          { icon: <TrendingDown size={20} color="#EF4444" />,  label: "Out of Stock",   value: String(summary.outOfStock), color: "#EF4444", f: "OUT_OF_STOCK" },
        ].map((c) => (
      ...
      <div style={{ flex: 1, minHeight: 0, overflowY: "auto", background: "#fff", borderRadius: 12, border: "1px solid #E2E8F0" }}>
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 860 }}>
            ...
            <tbody>
              {isLoading && <tr><td colSpan={10} style={{ padding: "48px", textAlign: "center" }}>
              ...
              {isError && <tr><td colSpan={10} style={{ padding: "48px", textAlign: "center", color: "#EF4444" }}>
