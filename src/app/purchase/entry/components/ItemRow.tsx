...
// rate (shown only when secondary unit is selected).
...
export function ItemRow({
  row, index, isFlash, products, canRemove,
  onChange, onRemove, onAddProduct,
}: ItemRowProps) {
    ...
    <>
      ...
      <tr style={{ borderBottom: "1px solid #F8FAFC" }}>
        ...
        <td style={{ ...td(), minWidth: 130, position: "relative" }}>
          <input ref={inputRef} style={ci} placeholder="Item name"
            value={search}
        ...
        {/* Item Code */}
        <td style={td(76)}><input style={ci} value={row.code} onChange={(e) => update("code", e.target.value)} /></td>
        ...
        {/* Size */}
        <td style={td(52)}><input style={ci} value={row.size} onChange={(e) => update("size", e.target.value)} /></td>
        ...
        <td style={td(80)}>
          <select style={{ ...ci, background: "transparent" }} value={row.unit}
        ...
        {/* Secondary Unit dropdown + converted qty */}
        <td style={td(120)}>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            <select style={{ ...ci, background: "transparent", flex: 1, minWidth: 0 }}
        ...
        {/* Tax % */}
        <td style={td(78)}>
          <select style={{ ...ci, background: "transparent" }} value={String(row.taxPct)}
