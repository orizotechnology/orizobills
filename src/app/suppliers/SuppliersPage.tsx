...
export default function SuppliersPage() {
  ...
  return (
    <div style={{ padding: "24px 28px", minHeight: "100%", background: "#F8FAFC" }}>
      ...
      <AnimatePresence>
        {dialog !== null && (
          <SupplierDialog supplier={dialog === "new" ? null : dialog} onClose={() => setDialog(null)} onSaved={onSaved} />
        )}
      </AnimatePresence>
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(15,23,42,0.5)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}
      ...
      <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.96 }}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid #F1F5F9" }}>
          <span style={{ fontWeight: 700, fontSize: 15, color: "#0F172A" }}>{isEdit ? "Edit Supplier" : "Add Supplier"}</span>
